...
# Licence : Apache 2.0
#
# Description : planification quotidienne de la notification des jeux a valider.
...
class GameValidationDailyNotificationScheduler:
    """Planifie la verification quotidienne des jeux en attente de validation."""

    DEFAULT_NOTIFICATION_TIME = "04:15"
    ENV_NOTIFICATION_TIME = "GAME_VALIDATION_DAILY_NOTIFICATION_TIME"

    def __init__(
        self,
        notification_service: GameValidationDailyNotificationService,
        scheduled_time: time,
        ...
        Args:
            notification_service (GameValidationDailyNotificationService): Service execute.
    ...
    @classmethod
    def from_environment(cls) -> "GameValidationDailyNotificationScheduler":
        ...
        Returns:
            GameValidationDailyNotificationScheduler: Planificateur configure.
        """
        ...
        return cls(
            GameValidationDailyNotificationService.from_environment(),
    ...
    def parse_scheduled_time(cls, raw_value: str | None) -> time:
        ...
        Returns:
            time: Heure locale interpretee, ou `04:15` par defaut.
        """
    ...
    def start(self) -> bool:
        ...
        thread.start()
        self.logger.info(
            "Notification quotidienne jeux a valider planifiee a %s.",
    ...
    def run_once(self) -> int:
        """Execute immediatement une verification des jeux a valider.
        ...
        return self.notification_service.notify_if_waiting_games_exist()
    ...
    def _run_forever(self) -> None:
        while True:
            ...
            try:
                ...
                self.logger.exception("Echec de la notification quotidienne jeux a valider.")
