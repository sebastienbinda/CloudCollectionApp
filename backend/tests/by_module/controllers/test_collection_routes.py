...
class CollectionRoutesTest(BaseAppRoutesTest):
    ...
    def test_collection_statistics_platforms_and_games_return_sql_contracts(self):
        ...
        self.assertEqual("1986-02-21", statistics["first_game_date"])
        self.assertEqual("2017-03-03", statistics["last_game_date"])
        self.assertEqual(42, statistics["collection"]["total"])
        self.assertEqual("1986-02-21", statistics["collection"]["first_game_date"])
        self.assertEqual("2017-03-03", statistics["collection"]["last_game_date"])
        self.assertEqual(3, statistics["wishlist"]["total"])
        self.assertEqual("1987-12-18", statistics["wishlist"]["first_game_date"])
        self.assertEqual("1990-04-27", statistics["wishlist"]["last_game_date"])
