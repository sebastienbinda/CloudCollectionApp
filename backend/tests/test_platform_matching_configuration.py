...
class PlatformMatchingConfigurationTest(unittest.TestCase):
    ...
    def test_from_environment_uses_defaults_and_custom_values(self):
        ...
        with patch.dict(
            os.environ,
            {"MATCHING_LOW_LVL_RATING": "30", "MATCHING_HIGH_LEVEL_RATING": "80"},
            clear=True,
        ):
    ...
    def test_from_environment_rejects_invalid_values(self):
        ...
        invalid_environments = [
            {"MATCHING_LOW_LVL_RATING": "bad"},
            {"MATCHING_LOW_LVL_RATING": "75", "MATCHING_HIGH_LEVEL_RATING": "75"},
            {"MATCHING_LOW_LVL_RATING": "-1"},
            {"MATCHING_HIGH_LEVEL_RATING": "101"},
        ]
